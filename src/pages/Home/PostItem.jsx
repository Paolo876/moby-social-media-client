...
import { Grid, Paper, Button, Typography, useTheme, Stack, IconButton, Chip } from '@mui/material';
    ...
    >
      <Button sx={{width: "100%", mr: "auto", p:0, textTransform: "none", textAlign: "left", borderRadius: "10px 10px 0 0"}} color="primary">
        <Paper sx={{position: "relative", width: "100%", p: 3, minHeight: 250, borderRadius: "10px 10px 0 0"}} variant="outlined">
          {!isPublic && <IconButton sx={{position: "absolute", top: 5, left: 5, opacity: .8}} color="info"><LockIcon fontSize="small"/></IconButton>}
          ...
          <Typography variant="h5" align='center' fontWeight={600} sx={{position:"absolute", top: "40%", left: "50%", transform: "translate(-50%,-50%)" }}>{title}</Typography>
