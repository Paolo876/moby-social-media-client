...
import { Paper, Typography, Stack, Grid, ButtonBase, Divider  } from '@mui/material';
...
const PostComments = ({ comments, likes }) => {
  ...
  return (
    <Grid container my={2} sx={{overflowY: "scroll", maxHeight: "89vh"}} pr={3}>
      ...
      {comments.map(item => <Grid item xs={12} mb={1} px={.5} key={item.id}>
